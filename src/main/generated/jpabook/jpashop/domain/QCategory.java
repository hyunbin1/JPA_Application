...
public class QCategory extends EntityPathBase<Category> {
    ...
    public final ListPath<jpabook.jpashop.domain.item.Items, jpabook.jpashop.domain.item.QItems> items = this.<jpabook.jpashop.domain.item.Items, jpabook.jpashop.domain.item.QItems>createList("items", jpabook.jpashop.domain.item.Items.class, jpabook.jpashop.domain.item.QItems.class, PathInits.DIRECT2);
